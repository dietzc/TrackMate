...
public class RecursiveCumSumTest
{
	...
	public static void setUpBeforeClass() throws Exception
	{
		...
		final int[] c11 = new int[] { 1 };
		final int[] c111 = new int[] { 1 };
		final int[] c112 = new int[] { 1 };
		final int[] c12 = new int[] { 1 };
		final int[] c2 = new int[] { 1 };
	...
	{
		final Function2< int[], int[] > function = new Function2< int[], int[] >()
		{
			@Override
		...
		final RecursiveCumSum< int[], DefaultEdge > fun = new RecursiveCumSum< int[], DefaultEdge >( tree, function );
		final int[] val = fun.apply( root );
