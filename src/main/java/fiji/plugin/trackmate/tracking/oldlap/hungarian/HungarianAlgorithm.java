 ...
 * problem.
 * <p>
 * Modified by Nick Perry to allow for 'blocking.' An assignment can be blocked,
 * making it impossible for it to be a solution. A blocked assignment contains
 * the value Double.MAX_VALUE.
 * <p>
