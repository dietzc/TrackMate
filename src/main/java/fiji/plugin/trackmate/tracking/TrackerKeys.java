...
public class TrackerKeys
{
	 ...
	 * particles. Expected values should be a {@link Map<String, Double>} where
	 * the map keys are spot feature names.
	 *
	 ...
	 * gap-closing events. Expected values should be a {@link Map<String,
	 * Double>} where the map keys are spot feature names.
	 *
	 * @see Spot#getFeature(String)
	 */
	 ...
	 * merging events. Expected values should be a {@link Map<String, Double>}
	 * where the map keys are spot feature names.
	 *
	 * @see Spot#getFeature(String)
	 */
	...
	/**
	 * Key for the parameter specifying the feature penalties when dealing with
	 * splitting events. Expected values should be a {@link Map<String, Double>}
	 * where the map keys are spot feature names.
	 *
	 * @see Spot#getFeature(String)
	 */
	...
	/**
	 * Key for the cutoff percentile parameter. Exepcted values are
	 * {@link Double}s.
	 */
